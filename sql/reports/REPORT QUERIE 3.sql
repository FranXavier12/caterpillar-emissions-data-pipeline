/* a complex query that adapts the base query into an aggregate report of all worksites operated by Shaanxi Coal & Chemical; this report 
	contains fractional compliance results indicating what proportion of machine-work-hours are operating within compliance limits */

select worksite_address, territory_address,
...
group by worksite_address, territory_address
